...
buf的位置是($ebp - 0x208),在用gdb调试的过程中，对于这个位置的查询返回了这些结果：
	...
	0x55683168, 0x55683178, 0x556830e8, 0x556831c8

所以我取了0x556831e8。试了一下，成功结束。Congratulations, general!

## 感想
五星好评。这个实验真的很精彩，几个任务的名称Candle,Sparkler...和"bomb"紧密相关，成功和失败的函数提示也很好玩，像什么smoke(),fizz(嘶嘶声), dub(哑弹)...，让人在写作业的时候感觉就像在玩一个游戏，没有觉得烦，不知不觉就完成了实验，甚至还有些意犹未尽。 

更重要的是，这个实验的负担不大，也没有让人绞尽脑汁的“自由发挥”内容。如果所有的大作业都像这样多好，杨老师和这门课的助教真是太厉害了！清华大学的计算机学科不愧是世界第一！

当然，后来我知道了buflab的出处。不过，还是非常感谢老师和助教能为我们选择这个实验。真的是受益匪浅！